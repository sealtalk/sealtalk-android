...
public interface GroupMemberDao {
    ...
    @Query(
            "SELECT group_member.user_id, group_member.group_id, group_member.nickname, group_member.role, group_member.join_time, nickname_spelling,user.name, user.name_spelling, user.portrait_uri"
                    + " FROM group_member "
    ...
    @Query(
            "SELECT group_member.user_id, group_member.group_id, group_member.nickname, group_member.role, group_member.join_time, nickname_spelling,user.name, user.name_spelling, user.portrait_uri, user.alias"
                    + " FROM group_member "
                    + "INNER JOIN user ON group_member.user_id = user.id "
