...
// {
//                    RichContentItem richContentItem = ((PublicServiceRichContentMessage)
...
//                PublicServiceMultiRichContentMessage multiRichContentMessage =
// (PublicServiceMultiRichContentMessage) message.getContent();
//                if (multiRichContentMessage != null) {
//                    ArrayList<RichContentItem> richContentItemsList =
// multiRichContentMessage.getMessages();
//                    if (richContentItemsList != null) {
//                        for (RichContentItem richContentItem : richContentItemsList) {
//                            if (richContentItem != null)
//                                forwardMessagesList.add(getRichContentMessage(richContentItem,
// message));
//                        }
//                    }
//                }
...
// extends Parcelable>) forwardMessagesList);
...
// RichContentMessage.obtain(richContentItem.getTitle(), richContentItem.getDigest(),
//                richContentItem.getImageUrl(), richContentItem.getUrl());
//        Message forwardMessage = Message.obtain(message.getTargetId(),
// message.getConversationType(), richContentMessage);
