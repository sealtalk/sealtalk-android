...
public class SealGroupConNtfMessageProvider
        extends BaseNotificationMessageItemProvider<SealGroupConNtfMessage> {
    ...
    protected ViewHolder onCreateMessageContentViewHolder(ViewGroup parent, int viewType) {
        View view =
                LayoutInflater.from(parent.getContext())
                        .inflate(
                                R.layout.rc_group_regular_clear_notification_message,
                                parent,
                                false);
    ...
    protected void bindMessageContentViewHolder(
            ...
            SealGroupConNtfMessage content,
            UiMessage message,
            int position,
            List<UiMessage> list,
            ...
            if (!TextUtils.isEmpty(content.getOperation())) {
                ...
                if (content.getOperation().equals("closeRegularClear")) {
                    textView.setText(
                            holder.getContext()
                                    .getResources()
                                    .getString(R.string.seal_set_clean_time_notification_close));
                } else if (content.getOperation().equals("openRegularClear")) {
                    contentStr =
                            holder.getContext()
                                    .getResources()
                                    .getString(R.string.seal_set_clean_time_notification_open);
                } else {
                    String operatorUserName = "";
                    if (RongUserInfoManager.getInstance().getUserInfo(content.getOperatorUserId())
                            != null) {
                        operatorUserName =
                                RongUserInfoManager.getInstance()
                                        .getUserInfo(content.getOperatorUserId())
                                        .getName();
                    }
                    if (content.getOperation().equals("openScreenNtf")) {
                        contentStr =
                                holder.getContext()
                                        .getResources()
                                        .getString(R.string.seal_set_screen_capture_open);
                    } else if (content.getOperation().equals("closeScreenNtf")) {
                        contentStr =
                                holder.getContext()
                                        .getResources()
                                        .getString(R.string.seal_set_screen_capture_close);
                    } else if (content.getOperation().equals("sendScreenNtf")) {
                        contentStr =
                                holder.getContext()
                                        .getResources()
                                        .getString(R.string.seal_set_screen_capture_use);
                    }
                    if (!TextUtils.isEmpty(operatorUserName)) {
                        if (content.getOperatorUserId()
                                .equals(RongIM.getInstance().getCurrentUserId())) {
                            contentStr =
                                    holder.getContext()
                                                    .getResources()
                                                    .getString(R.string.seal_set_screen_capture_you)
                                            + contentStr;
                        } else {
    ...
    public Spannable getSummarySpannable(Context context, SealGroupConNtfMessage message) {
        ...
        if (!TextUtils.isEmpty(message.getOperation())) {
            ...
            if (message.getOperation().equals("closeRegularClear")) {
                ...
                String operatorUserName = "";
                if (RongUserInfoManager.getInstance().getUserInfo(message.getOperatorUserId())
                        != null) {
                    operatorUserName =
                            RongUserInfoManager.getInstance()
                                    .getUserInfo(message.getOperatorUserId())
                                    .getName();
                }
                if (message.getOperation().equals("openScreenNtf")) {
                    content =
                            context.getResources().getString(R.string.seal_set_screen_capture_open);
                    ...
                    content =
                            context.getResources().getString(R.string.seal_set_screen_capture_use);
                }
                if (!TextUtils.isEmpty(operatorUserName)) {
                    if (message.getOperatorUserId()
                            .equals(RongIM.getInstance().getCurrentUserId())) {
                        operatorUserName =
                                context.getResources()
                                        .getString(R.string.seal_set_screen_capture_you);
