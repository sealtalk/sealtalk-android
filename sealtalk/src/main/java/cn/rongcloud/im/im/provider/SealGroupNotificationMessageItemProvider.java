                ...
                if (content.getOperation().equals("Transfer")) {
                    ...
                    if (!TextUtils.isEmpty(data)) {
                        ...
                        try {
                            ...
                            JSONArray targetUserDisplayNames =
                                    jsonObject.getJSONArray("targetUserDisplayNames");
                            ...
                            String contentStr =
                                    holder.getContext()
                                            .getResources()
                                            .getString(
                                                    R.string.seal_group_action_transfer_group_owner,
                                                    buffer.toString());
                        ...
                        try {
                            ...
                            String contentStr =
                                    holder.getContext()
                                            .getResources()
                                            .getString(
                                                    R.string.seal_group_action_set_manager,
                                                    buffer.toString());
                            textView.setText(contentStr);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        ...
                        try {
                            ...
                            String contentStr =
                                    holder.getContext()
                                            .getResources()
                                            .getString(
                                                    R.string.seal_group_action_remove_manager,
                                                    buffer.toString());
                            textView.setText(contentStr);
                        } catch (JSONException e) {
                            e.printStackTrace();
                    ...
                    String contentStr =
                            holder.getContext()
                                    .getResources()
                                    .getString(R.string.seal_group_member_protection_open);
                    textView.setText(contentStr);
                    ...
                    String contentStr =
                            holder.getContext()
                                    .getResources()
                                    .getString(R.string.seal_group_member_protection_close);
                    textView.setText(contentStr);
                } else {
