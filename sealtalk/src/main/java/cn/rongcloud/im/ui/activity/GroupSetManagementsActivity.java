...
public class GroupSetManagementsActivity extends TitleBaseActivity {
    ...
    private void initView() {
        ...
        getTitleBar()
                .setOnBtnRightClickListener(
                        getString(R.string.seal_group_manager_confirm),
                        new View.OnClickListener() {

                            @Override
                            public void onClick(View v) {
                                List<GroupMember> selectedMember =
                                        groupManagerAdapter.getSelectedMember();
        ...
        groupManagerAdapter.setOnGroupManagerListener(
                new GroupManagerAdapter.OnGroupManagerListener() {
                    @Override
                    public void onSelected(int number, List<GroupMember> selected) {
                        if (number > 0) {
                            ...
                            getTitleBar()
                                    .setRightText(getString(R.string.seal_group_manager_confirm));
                        }
                    }

                    @Override
                    public void onAlreadyReachedMaxSize(
                            List<GroupMember> selected, List<GroupMember> notSelected) {
                        showToast(
                                getString(
                                        R.string
                                                .seal_group_management_toast_management_already_reached_max_size,
                                        (selected.size() + notSelected.size())));
                    }
                });
    ...
    private void initViewModel() {
        ...
        groupManagementViewModel
                .getGroupMembersWithoutGroupOwner()
                .observe(
                        this,
                        ...
                        new Observer<Resource<Void>>() {
                            ...
                            public void onChanged(Resource<Void> resource) {
                                ...
                                if (resource.status == Status.SUCCESS) {
                                    showToast(
                                            R.string
                                                    .seal_group_manager_set_manager_toast_set_management_success);
                                    finish();
                                    ...
                                    if (!TextUtils.isEmpty(resource.message)) {
                                        ...
                                        showToast(
                                                R.string
                                                        .seal_group_manager_set_manager_toast_set_management_failed);
                                    }
                                } else {
                                    // TODO loading
                                }
    ...
    private void showConfirmDialog(List<GroupMember> members) {
        ...
        String content =
                getString(
                        R.string.seal_group_manager_select_managements_dialog_content,
                        buffer.toString());
