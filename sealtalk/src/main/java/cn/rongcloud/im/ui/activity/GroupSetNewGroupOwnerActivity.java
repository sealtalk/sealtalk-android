...
public class GroupSetNewGroupOwnerActivity extends TitleBaseActivity {
                        ...
                        new Observer<Resource<Void>>() {
                            ...
                            public void onChanged(Resource<Void> resource) {
                                ...
                                if (resource.status == Status.SUCCESS) {
                                    ...
                                    showToast(
                                            R.string
                                                    .seal_group_management_toast_set_new_group_onwer_success);
                                } else if (resource.status == Status.ERROR) {
                                    showToast(
                                            R.string
                                                    .seal_group_management_toast_set_new_group_onwer_failed);
                                } else {
    ...
    private void showConfirmDialog(List<GroupMember> selectedMember) {
        ...
        builder.setContentMessage(
                getString(
                        R.string.seal_group_manager_transfer_group_owner_dialog_content,
                        member.getName()));
