...
public class SearchFriendActivity extends TitleBaseActivity
        implements OnSearchFriendClickListener, OnSearchFriendItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel
                ...
                .observe(
                        this,
                        new Observer<Resource<SearchFriendInfo>>() {
                            @Override
                            public void onChanged(
                                    Resource<SearchFriendInfo> searchFriendInfoResource) {
                                if (searchFriendInfoResource.status == Status.SUCCESS
                                    ...
                                    searchFriendResultFragment.setData(
                                    ...
                                    Toast.makeText(
                                                    SearchFriendActivity.this,
                                                    R.string.seal_account_not_exist,
                                                    Toast.LENGTH_SHORT)
                                            .show();
                                }
                            }
    ...
    public void onSearchFriendItemClick(SearchFriendInfo searchFriendInfo) {
        if (isFriend
                || searchFriendInfo.getId().equals(RongIMClient.getInstance().getCurrentUserId())) {
