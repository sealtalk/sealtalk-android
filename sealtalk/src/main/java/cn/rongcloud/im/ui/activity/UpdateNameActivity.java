    ...
    private void initView() {
        ...
        getTitleBar()
                .setOnBtnRightClickListener(
                        getString(R.string.seal_update_name_save_update),
                        new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (!TextUtils.isEmpty(newName)) {
                                    ...
                                    showToast(
                                            R.string
                                                    .seal_update_name_toast_nick_name_can_not_empty);
                        ...
                        new Observer<Resource<UserInfo>>() {
                            ...
                            public void onChanged(Resource<UserInfo> resource) {
                                if (resource.data != null) {
                                    String name =
                                            TextUtils.isEmpty(resource.data.getName())
                                                    ? ""
                        ...
                        new Observer<Resource<Result>>() {
                            ...
                            public void onChanged(Resource<Result> resultResource) {
                                if (resultResource.status == Status.SUCCESS) {
                                    showToast(
                                            R.string
                                                    .seal_update_name_toast_nick_name_change_success);
                                    finish();
