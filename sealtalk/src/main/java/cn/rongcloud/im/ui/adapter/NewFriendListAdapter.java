...
public class NewFriendListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView =
                    View.inflate(parent.getContext(), R.layout.new_friends_item_user_ship, null);
            holder.nameTv = (TextView) convertView.findViewById(R.id.tv_name);
            holder.messageTv = (TextView) convertView.findViewById(R.id.tv_message);
            holder.headIv =
                    (SelectableRoundedImageView) convertView.findViewById(R.id.iv_new_header);
        ...
        holder.stateTv.setOnClickListener(
        ...
        holder.ignoreTv.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (mOnItemButtonClick != null) {
        ...
        switch (FriendStatus.getStatus(info.getStatus())) {
            case RECEIVE_REQUEST: // 收到了好友邀请
                ...
                holder.stateTv.setBackgroundDrawable(
                        parent.getContext()
                                .getResources()
                                .getDrawable(R.drawable.seal_new_friend_add_friend_selector));
    ...
    /**
     * displayName : message : 手机号:18622222222昵称:的用户请求添加你为好友 status : 11 updatedAt :
     * 2016-01-07T06:22:55.000Z user : {"id":"i3gRfA1ml","nickname":"nihaoa","portraitUri":""}
     */
    class ViewHolder {
