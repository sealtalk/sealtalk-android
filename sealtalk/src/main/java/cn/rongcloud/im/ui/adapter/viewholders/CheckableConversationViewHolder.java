...
public class CheckableConversationViewHolder
    ...
    public CheckableConversationViewHolder(
            @NonNull View itemView, OnCheckConversationClickListener listener) {
        super(itemView);
    ...
    public void update(CheckableContactModel conversationContactModel) {
        ...
        if (conversationContactModel.getBean() instanceof GroupEntity) {
            ...
            ImageLoaderUtils.displayUserPortraitImage(
                    info.getUser().getPortraitUri(), protraitImageView);
        }
