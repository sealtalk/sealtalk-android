...
public class SelectBaseFragment extends BaseContactFragment implements OnCheckContactClickListener {
    ...
    protected void onInitView(Bundle savedInstanceState, Intent intent) {
        ...
        uncheckableInitIdList =
                intent.getStringArrayListExtra(LIST_CAN_NOT_CHECK_ID_LIST); // 不可选的列表
        ...
        checkedInitIdList =
                intent.getStringArrayListExtra(LIST_ALREADY_CHECKED_USER_ID_LIST); // 已经选择的列表
        checkedInitGroupList =
                intent.getStringArrayListExtra(LIST_ALREADY_CHECKED_GROUP_ID_LIST); // 已经选择的群组
    ...
    private Observer observable =
            new Observer<List<ContactModel>>() {
