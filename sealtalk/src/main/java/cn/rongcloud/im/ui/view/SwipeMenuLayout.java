...
public class SwipeMenuLayout extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        // LogUtils.e(TAG, "onLayout() called with: " + "changed = [" + changed + "], l = [" + l +
        // "], t = [" + t + "], r = [" + r + "], b = [" + b + "]");
        int childCount = getChildCount();
        ...
        // Log.d(TAG, "onLayout() called with: " + "maxScrollGap = [" + maxScrollGap + "], l = [" +
        // l + "], t = [" + t + "], r = [" + r + "], b = [" + b + "]");
    }
        ...
        if (isSwipeEnable) {
            ...
            switch (ev.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (Math.abs(gap) > 10
                            || Math.abs(getScrollX()) > 10) { // 2016 09 29 修改此处，使屏蔽父布局滑动更加灵敏，
                        getParent().requestDisallowInterceptTouchEvent(true);
                    }
    ...
    public void smoothExpand() {
        ...
        mExpandAnim =
                ValueAnimator.ofInt(
                        getScrollX(), isLeftSwipe ? mRightMenuWidths : -mRightMenuWidths);
