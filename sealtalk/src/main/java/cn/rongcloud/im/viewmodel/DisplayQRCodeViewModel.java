...
public class DisplayQRCodeViewModel extends AndroidViewModel {
    ...
    public void requestGroupQRCode(
            String groupId, String sharedUserId, int qrCodeWidth, int qrCodeHeight) {
        qrCodeResult.setSource(
                qrCodeManager.getGroupQRCode(groupId, sharedUserId, qrCodeWidth, qrCodeHeight));
    }
