...
public class PrivacyViewModel extends AndroidViewModel {
     ...
     * @return
     */
    public void setPrivacy(int phoneVerify, int stSearchVerify, int friVerify, int groupVerify) {
        setPrivacyResult.setSource(
                privacyTask.setPrivacy(phoneVerify, stSearchVerify, friVerify, groupVerify));
    }
