...
public class SelectBaseViewModel extends AndroidViewModel {
    ...
    protected SingleSourceMapLiveData<Resource<List<FriendShipInfo>>, List<ContactModel>>
            friendsLiveData;
    protected SingleSourceMapLiveData<List<FriendShipInfo>, List<ContactModel>>
            groupFriendsLiveData;
    protected SingleSourceMapLiveData<List<FriendShipInfo>, List<ContactModel>>
            excludeGroupLiveData;
    ...
    public SelectBaseViewModel(@NonNull Application application) {
        ...
        friendsLiveData =
                new SingleSourceMapLiveData<>(
                        new Function<Resource<List<FriendShipInfo>>, List<ContactModel>>() {
                            @Override
        ...
        groupFriendsLiveData =
                new SingleSourceMapLiveData<>(
                        new Function<List<FriendShipInfo>, List<ContactModel>>() {
                            @Override
        ...
        allGroupMemberLiveData =
                new SingleSourceMapLiveData<>(
                        new Function<List<GroupMember>, List<ContactModel>>() {
                            @Override
    ...
    public void loadFriendShip(
            ArrayList<String> uncheckableIdList,
    ...
    public void searchFriend(String keyword) {
        ...
        // 转换数据库搜索结果
        LiveData<Resource<List<FriendShipInfo>>> resourceLiveData =
                Transformations.switchMap(
                        searchDbLiveData,
                        new Function<
                                List<FriendShipInfo>, LiveData<Resource<List<FriendShipInfo>>>>() {
                            @Override
                            public LiveData<Resource<List<FriendShipInfo>>> apply(
                                    List<FriendShipInfo> input) {
     ...
     * @param groupId
     */
    public void loadGroupMemberExclude(
            String groupId, ArrayList<String> excludeList, ArrayList<String> includeList) {
    ...
    public void loadGroupMemberExclude(String groupId) {
        ...
        groupMemberListLiveData.addSource(
    ...
    private List<ContactModel> convert(List<FriendShipInfo> input) {
        ...
        for (FriendShipInfo friendShipInfo : input) {
            ...
            if (TextUtils.isEmpty(firstChar)) {
                model =
                        new ContactModel(
                                new CharacterTitleInfo("#"), R.layout.contact_contact_title);
                temp = "#";
                output.add(model);
            } else if (!temp.equals(firstChar)) {
                model =
                        new ContactModel(
                                new CharacterTitleInfo(firstChar), R.layout.contact_contact_title);
                temp = firstChar;
                output.add(model);
            }
            CheckableContactModel<FriendShipInfo> checkableContactModel =
                    new CheckableContactModel(
                            friendShipInfo, R.layout.select_fragment_contact_item);
            if (uncheckableContactIdList != null
                    && uncheckableContactIdList.contains(
                            checkableContactModel.getBean().getUser().getId())) {
    ...
    private List<ContactModel> convertGroupMember(List<GroupMember> input) {
        ...
        for (GroupMember groupMember : input) {
            ...
            CheckableContactModel<GroupMember> checkableContactModel =
                    new CheckableContactModel<>(groupMember, R.layout.select_fragment_contact_item);
            if (uncheckableContactIdList != null
                    && uncheckableContactIdList.contains(
                            checkableContactModel.getBean().getUserId())) {
                checkableContactModel.setCheckType(CheckType.DISABLE);
            }
            SLog.i(
                    TAG,
                    "checkableContactModel.getBean().getUser().getId(): "
                            + checkableContactModel.getBean().getUserId());
            if (checkedContactIdList != null
                    && checkedContactIdList.contains(checkableContactModel.getBean().getUserId())) {
                checkableContactModel.setCheckType(CheckType.CHECKED);
            }
            output.add(checkableContactModel);
        }
    ...
    public void cancelAllCheck() {
        ...
        for (ContactModel model : ContactModels) {
            if (model.getType() == R.layout.select_fragment_contact_item) {
                CheckableContactModel<FriendShipInfo> checkableContactModel =
                        (CheckableContactModel<FriendShipInfo>) model;
    ...
    public SingleSourceMapLiveData<List<FriendShipInfo>, List<ContactModel>>
            getGroupFriendsLiveData() {
        return groupFriendsLiveData;
    }

    public SingleSourceMapLiveData<List<FriendShipInfo>, List<ContactModel>>
            getExcludeGroupLiveData() {
