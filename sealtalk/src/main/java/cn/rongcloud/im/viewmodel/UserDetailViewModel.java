...
public class UserDetailViewModel extends AndroidViewModel {
    ...
    private SingleSourceMapLiveData<Resource<AddFriendResult>, Resource<AddFriendResult>>
            inviteResult;
    ...
    public UserDetailViewModel(@NonNull Application application, String userId) {
                ...
                friendShipInfoResource -> {
                    ...
                    if (friendShipInfoResource.status != Status.LOADING) {
                        ...
                        userInfoLiveData.addSource(
                                ...
                                resource -> userInfoLiveData.setValue(resource));
                    }
                });
        ...
        addBlackListResult =
                new SingleSourceMapLiveData<>(
                        new Function<Resource<Void>, Resource<Void>>() {
                            @Override
